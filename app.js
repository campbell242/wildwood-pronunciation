...
(function () {
  ...
  const TERMS = [
    ...
    {t:'Costi',ph:'Koh-tee',ipa:'/ˈkos.ti/',cat:'Character',d:'The cousin from Vârful cu Negură.'},
    {t:'Costin',ph:'Kohs-teen',ipa:'/kosˈtin/',cat:'Character',d:'A form of Costi’s name from the book’s pronunciation guide.'},
    ...
    {t:'Anastasia',ph:'Ah-nah-stah-see-yah',ipa:'/a.na.staˈsi.a/',cat:'Character',d:'A guest at Cezar’s gatherings.'},
    ...
    {t:'Ileana',ph:'Eel-leh-ah-nah',ipa:'/i.leˈa.na/',cat:'Character',d:'A dancer of the Other Kingdom.'},
    {t:'Marin',ph:'Mah-reen',ipa:'/maˈrin/',cat:'Character',d:'A name among the sisters’ wider circle of acquaintances.'},
    {t:'Răzvan',ph:'Rahz-vahn',ipa:'/rəzˈvan/',cat:'Character',d:'One of Cezar’s companions.'},
    {t:'Salem bin Afazi',ph:'Sah-lem bin Ah-fah-zee',ipa:'/ˈsa.lem bin aˈfa.zi/',cat:'Character',d:'A name among the sisters’ wider circle of acquaintances.'},
    {t:'Sandu',ph:'Sahn-doo',ipa:'/ˈsan.du/',cat:'Character',d:'A name among the sisters’ wider circle of acquaintances.'},
    {t:'Tadeusz',speak:'Tadeuș',ph:'Tah-deh-oosh (deh-oosh almost one syllable)',ipa:'/ˈta.dɛ.uʂ/',cat:'Character',d:'A striking stranger encountered away from Piscul Dracului.'},
    {t:'Teodor',ph:'The-oh-dor',ipa:'/te.oˈdor/',cat:'Character',d:'A name among the sisters’ wider circle of acquaintances.'},
